...
const PuzzleTwo = () => {
  ...
  const background = useImage(require("../../assets/sob/bg.jpg"));
  const frame = useImage(require("../../assets/sob/frame.png"));
  const picture = useImage(require("../../assets/sob/art1.jpg"));
